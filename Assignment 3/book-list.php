...
$query3 = "select * from ProductionStatuses order by ProductionStatus asc";
$result3 = mysqli_query($connection,$query3);

$query4 = "select * from BindingTypes order by BindingType asc";
...
?>
            <tr>
               <td><img src = "images/tinysquare/<?php echo utf8_encode($rows[1])?>.jpg"></td>
               <td><?php echo utf8_encode($rows[1])?></td>
               <td><a href="book-details.php" ><?php echo $rows[3]?></a></td>
            </tr>
<?php   } ?>
           </table>
         </div>           
...
$totalRows = mysqli_num_rows($result4);
    for ($counter = 0; $counter < $totalRows; ++$counter) {
                     $rows = mysqli_fetch_row($result4); ?>
                     
               <ul><a href= ><?php echo $rows[1]?></a></ul>
               <br>
<?php   } ?>   
             </ul>
         </div>           
